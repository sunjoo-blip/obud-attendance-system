...
- 미사용 연차는 **일당으로 환산**하여 급여에 포함해 정산합니다.
- 정산 시점: 매년 **입사 기념월 급여**에 직전 연차 기간의 미사용 연차 반영
- 지급일: 해당 월 월급날에 일괄 지급
...
| 정산 시점 | 정산 대상 기간 | 지급 연차 | 사용 연차 | 미사용 연차 | 정산 반영 급여 |
|---|---|---|---|---|---|
| 2026-05 월급 | 2025-05-01 ~ 2026-04-30 (2년차) | 15개 | (실사용) | 잔여분 | 2026-05 월급날 |
| 2027-05 월급 | 2026-05-01 ~ 2027-04-30 (3년차) | 15개 | (실사용) | 잔여분 | 2027-05 월급날 |

> **예시 계산** (직원 A, 2026-05 정산)
> - 2년차 연차 15개 중 실제 사용 10개 → 미사용 **5개**
> - 일 급여 = 월급 ÷ 통상 근무일수 (ex. 월급 300만원 ÷ 22일 = 136,363원/일)
> - 정산 금액 = 136,363원 × 5개 = **약 681,815원** → 2026년 5월 급여에 추가 지급

### 정산 흐름

```
입사 1주년(기념월 급여)
  └── 지난 1년간 미사용 연차 수 × 일당 → 당월 급여에 가산
...
> 정산은 시스템의 **관리자 > 작업 > 정산 내역**에서 연도별로 확인할 수 있습니다.
